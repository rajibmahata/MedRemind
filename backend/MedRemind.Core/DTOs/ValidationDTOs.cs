...
/// <summary>
/// DTOs for medication validation workflow
/// </summary>
...
public class ValidationWorkflowDto
{
    ...
    public List<MedicationValidationDto> Medications { get; set; } = new();
    public DateTime CreatedAt { get; set; }
}

public class MedicationValidationDto
{
...
public class SafetyWarningDto
{
    ...
    public string Severity { get; set; } = string.Empty; // Info, Warning, Danger
...
{
    public int PrescriptionId { get; set; }
    public bool UserConsultedPharmacist { get; set; }
