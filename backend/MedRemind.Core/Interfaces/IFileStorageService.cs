...
public interface IFileStorageService
{
    ...
    Task<string> SaveLlmResponseAsync(string provider, string jsonResponse, string prescriptionFileName);

    /// <summary>
    /// Save prescription analysis report generated by validation agent
    /// </summary>
    /// <param name="reportJson">JSON report content</param>
    /// <param name="prescriptionFileName">Prescription file name to associate with</param>
    /// <returns>Full path where report was saved</returns>
